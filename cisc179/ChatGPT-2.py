...
class GameOfLife:
    ...
    def start_animation(self):
        self.animation = animation.FuncAnimation(self.fig, self.update_generation, interval=200, blit=False, save_count=50)
        plt.show(block=True)  # Add this line to keep the plot window open
